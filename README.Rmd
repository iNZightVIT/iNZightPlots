...
```{r load, out.width = "50%", fig.align = "center"}
...
```{r usage_notation, out.width = "30%", fig.ncol=3}
...
```{r colours, out.width = "30%", fig.align = "center"}
...
```{r inference, out.width = "30%", fig.align = "center"}
...
```{r trends, out.width = "30%", fig.align = "center"}
inzplot(Sepal.Length ~ Sepal.Width, data = iris,
  trend = "linear",
  bs.inference = TRUE
)
