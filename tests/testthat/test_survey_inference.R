...
test_that("Subset inference - two sample t-test", {
    ...
    inz_tabs <- lapply(
        grep("Population Means", inz_test),
        function(i) {
            est_tbl <-
                read.table(
                    textConnection(
